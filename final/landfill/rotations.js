...
async function runProgram()
{
	...
	{	
		...
		readTextFile("file:///home/pi/UCI-Digital-Waste-Bin/final/landfill/result.json");
		console.log(result1);
		if(result2 != result1)
		{
			console.log("IT is different");
			result1 = result2;
			var result3 = 3.1526066 * result1;
			...
			var numAnim = new CountUp("tbox", 0.0, result1, 2, 3, options);
			if (!numAnim.error) {
				numAnim.start();
			} else {
